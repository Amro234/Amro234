# 👋 Hi there, I'm Amro Mohamed Ali Mahmoud

🎓 **Graduate Student – Sinai University (Class of 2025)**  
📱 **Mobile Application Development Intern**  
🏢 **ITI Ismailia – Professional 9-Month Program**

---

## 💡 About Me

I am a passionate and motivated developer with experience in **Web Development** and **Artificial Intelligence**, and currently focusing on **Mobile Application Development**.

I strongly believe in continuous learning. Every day, I explore new technologies and improve my skills to be well-prepared for real-world challenges and the competitive job market.
...
### 🎮 Tic Tac Toe Pro – Client
A **JavaFX client application** featuring:
- AI single-player mode  
- Local & online multiplayer  
- Game recording & replay  

🔗 https://github.com/Amro234/Client

---

### 🖥 Tic Tac Toe Pro – Server
A **server-side application** handling:
- Multiplayer connections  
- Authentication & sessions  
- Game challenges & data management  

🔗 https://github.com/Amro234/Server

---

### 🌍 Easy_Go-
A **web-based tourism project** combining frontend and backend logic.

🔗 https://github.com/Amro234/Easy_Go-

---

### 🧪 WDT Project
A team-based **Web Development Training project**.

🔗 https://github.com/7-th/WDT-Project

---

## 🎯 Career Objective

To work in a professional development environment where I can:
